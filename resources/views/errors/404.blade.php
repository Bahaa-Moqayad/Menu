...
<style>
    ...
    * {
    ...
    .number-left {
        text-align: right;
        -webkit-animation: var(--ufo-travel) left-apparition cubic-bezier(0.1, 0.5, 0.9, 0.5) forwards;
        animation: var(--ufo-travel) left-apparition cubic-bezier(0.1, 0.5, 0.9, 0.5) forwards;
    }
    ...
    .my-planet-planet {
        ...
        height: calc(10 * var(--length-unit));
        width: calc(10 * var(--length-unit));
        background-image: url(https://zupimages.net/up/21/38/qza3.png);
        /* planet texture, homemade :) */
    ...
    @-webkit-keyframes moving {
        ...
        20%,
        45% {
            transform: scale(1) translate(calc(50vw - calc(calc(10 * var(--length-unit))) - calc(40 * var(--ufo-length-unit))),
                    calc(-50vh - calc(7.5 * var(--length-unit))));
        }

        55%,
        80% {
            transform: translate(calc(50vw + calc(10 * var(--length-unit))),
                    calc(-50vh - calc(7.5 * var(--length-unit)))) scale(1);
        }
...
<body>
    ...
    <a href="{{ route('site.index') }}" class="signature">
        <div class="link">
            <span class="brace">
                {
            </span>
